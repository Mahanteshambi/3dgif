function payAmount(event) {
	...
	//document.getElementById('gif').src='https://3dgif.s3.ap-south-1.amazonaws.com/images/icons/favicon.ico';
	//$('gif').attr('src', 'https://3dgif.s3.ap-south-1.amazonaws.com/images/icons/favicon.ico');
	var URL = "https://mkf7lbssgj.execute-api.us-east-1.amazonaws.com/prod/get3d";
	var id = $("#quantity").val();
	var payee = getName()
	var data = {
          payee_id : payee,
    ...
    $.ajax({
         ...
         success: function (data, textStatus, xhr) {
		   ...
		   $("#3dgif").prop('src', data.body);
		   $('#url').html(data.body);
		   //document.getElementById('gif').src=data.body;
		   //var img = $('gif')
		   //img.src=data.body
